...
void PhysicsList::ConstructOp(){
  ...
  G4TransitionRadiation* trProcess = new G4ForwardXrayTR;
 ...
 theParticleIterator->reset();
  while( (*theParticleIterator)() ){
    ...
    if (trProcess->IsApplicable(*particle)) {
    	pmanager->AddDiscreteProcess(trProcess);
    	//G4cout << "TR applied to " << particle->GetParticleName() << G4endl;
    }
  }

  //G4cout << "Now I am here!" << G4endl;
}
